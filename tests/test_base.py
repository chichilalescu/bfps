...
def launch(
    ...
    if c.parameters['nparticles'] > 0:
        ...
        c.add_particles(integration_steps = 2, neighbours = 2, interp_type = 'Lagrange')
        c.add_particles(integration_steps = 2, neighbours = 3, interp_type = 'Lagrange')
        c.add_particles(integration_steps = 2, neighbours = 4, interp_type = 'Lagrange')
        c.add_particles(integration_steps = 2, neighbours = 5, interp_type = 'Lagrange')
        c.add_particles(integration_steps = 2, neighbours = 6, interp_type = 'Lagrange')
        c.add_particles(integration_steps = 2, neighbours = 7, interp_type = 'Lagrange')
        c.add_particles(integration_steps = 2, neighbours = 8, interp_type = 'Lagrange')
